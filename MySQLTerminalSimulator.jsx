      ...
      <div className="max-w-5xl mx-auto space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <motion.div initial={{opacity:0, y:10}} animate={{opacity:1, y:0}} className="bg-black/50 rounded-2xl shadow-xl border border-white/10 p-4">
            ...
            <div ref={outputContainerRef} className="bg-black rounded-xl p-3 h-64 sm:h-[420px] overflow-auto border border-white/10">
            ...
            <div className="mt-3 flex items-start gap-2">
              ...
              />
              <button onClick={onEnter} className="px-3 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 shadow h-fit mt-1">
